...
| Field | Value |
|---|---|
| Folder Name | agent_cli |
| Relative Path | agent_cli |
| Absolute Path | /mnt/deepa/rag/agent_cli |
| Runtime Detected | Python (13 files) |
| File Count | 14 |
| Lines of Code (rough) | 534 |
| README present | Yes |
...
| AI / LLM Dependencies (detected) | Ollama client |
