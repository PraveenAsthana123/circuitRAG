# 📦 `hybrid_architect` — Advanced README
  ...
  ·  **Path:** `hybrid_architect`  ·  **Generated:** 2026-05-16 19:57 UTC
...
|---|---|---|---|---|---|
| `__init__.py` | 🚀 entry point / app bootstrap | 0 | 0 | 27 | hybrid_architect — Hub-and-Spoke + Council composition (CLAUDE.md §47). |
