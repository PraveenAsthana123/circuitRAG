...
**Folder under review:** `hybrid_architect`
...
| Field | Value |
|---|---|
| Folder Name | hybrid_architect |
| Relative Path | hybrid_architect |
| Absolute Path | /mnt/deepa/rag/hybrid_architect |
| Runtime Detected | Python (2 files) |
| File Count | 3 |
| Lines of Code (rough) | 315 |
| README present | Yes |
