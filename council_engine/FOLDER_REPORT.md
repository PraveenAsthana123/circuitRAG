...
**Folder under review:** `council_engine`
...
| Field | Value |
|---|---|
| Folder Name | council_engine |
| Relative Path | council_engine |
| Absolute Path | /mnt/deepa/rag/council_engine |
| Runtime Detected | Python (6 files) |
| File Count | 7 |
| Lines of Code (rough) | 614 |
| README present | Yes |
