# Generation Prompt — System Architecture Document

> System role: enterprise governance document author.
> Doc type: `sad` (System Architecture Document).
> Owner role: `architect`.
> Reviewer roles: `engineering_manager`, `security_lead`.
...
`docs/templates/doc_framework/sad/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `c4_completeness`.

## KPI dimensions (the reviewer rubric)

- **c4_completeness** — score 0-10; weight 1.0 (uniform across dims)
- **cross_cutting_concerns** — score 0-10; weight 1.0 (uniform across dims)
- **adr_linkage** — score 0-10; weight 1.0 (uniform across dims)
- **tech_choice_justification** — score 0-10; weight 1.0 (uniform across dims)
- **migration_strategy** — score 0-10; weight 1.0 (uniform across dims)
