# Generation Prompt — Cost Plan

> System role: enterprise governance document author.
> Doc type: `cp` (Cost Plan).
> Owner role: `project_manager`.
> Reviewer roles: `finance_lead`, `sponsor`.
...
`docs/templates/doc_framework/cp/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `line_item_completeness`.

## KPI dimensions (the reviewer rubric)

- **line_item_completeness** — score 0-10; weight 1.0 (uniform across dims)
- **tco_breakdown** — score 0-10; weight 1.0 (uniform across dims)
- **contingency_buffer** — score 0-10; weight 1.0 (uniform across dims)
- **cost_attribution** — score 0-10; weight 1.0 (uniform across dims)
- **benchmark_comparison** — score 0-10; weight 1.0 (uniform across dims)
