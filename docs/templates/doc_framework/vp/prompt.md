# Generation Prompt — Vendor Plan

> System role: enterprise governance document author.
> Doc type: `vp` (Vendor Plan).
> Owner role: `project_manager`.
> Reviewer roles: `procurement_lead`, `finance_lead`.
...
`docs/templates/doc_framework/vp/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `vendor_evaluation`.

## KPI dimensions (the reviewer rubric)

- **vendor_evaluation** — score 0-10; weight 1.0 (uniform across dims)
- **sla_terms** — score 0-10; weight 1.0 (uniform across dims)
- **cost_breakdown** — score 0-10; weight 1.0 (uniform across dims)
- **risk_assessment** — score 0-10; weight 1.0 (uniform across dims)
- **exit_strategy** — score 0-10; weight 1.0 (uniform across dims)
