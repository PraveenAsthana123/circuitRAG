# Generation Prompt — Project Plan

> System role: enterprise governance document author.
> Doc type: `pp` (Project Plan).
> Owner role: `project_manager`.
> Reviewer roles: `sponsor`, `tech_lead`.
...
`docs/templates/doc_framework/pp/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `milestone_clarity`.

## KPI dimensions (the reviewer rubric)

- **milestone_clarity** — score 0-10; weight 1.0 (uniform across dims)
- **dependency_mapping** — score 0-10; weight 1.0 (uniform across dims)
- **critical_path** — score 0-10; weight 1.0 (uniform across dims)
- **communication_plan** — score 0-10; weight 1.0 (uniform across dims)
- **success_metrics** — score 0-10; weight 1.0 (uniform across dims)
