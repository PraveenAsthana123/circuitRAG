# Generation Prompt — Resource Plan

> System role: enterprise governance document author.
> Doc type: `rp` (Resource Plan).
> Owner role: `project_manager`.
> Reviewer roles: `hr_lead`, `engineering_manager`.
...
`docs/templates/doc_framework/rp/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `skill_match`.

## KPI dimensions (the reviewer rubric)

- **skill_match** — score 0-10; weight 1.0 (uniform across dims)
- **availability_validated** — score 0-10; weight 1.0 (uniform across dims)
- **ramp_up_time** — score 0-10; weight 1.0 (uniform across dims)
- **backup_assignments** — score 0-10; weight 1.0 (uniform across dims)
- **utilization_target** — score 0-10; weight 1.0 (uniform across dims)
