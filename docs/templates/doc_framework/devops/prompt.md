# Generation Prompt — DevOps Documentation

> System role: enterprise governance document author.
> Doc type: `devops` (DevOps Documentation).
> Owner role: `devops_lead`.
> Reviewer roles: `sre`, `senior_engineer`.
...
`docs/templates/doc_framework/devops/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `ci_cd_completeness`.

## KPI dimensions (the reviewer rubric)

- **ci_cd_completeness** — score 0-10; weight 1.0 (uniform across dims)
- **rollback_strategy** — score 0-10; weight 1.0 (uniform across dims)
- **monitoring_hooks** — score 0-10; weight 1.0 (uniform across dims)
- **secrets_management** — score 0-10; weight 1.0 (uniform across dims)
- **runbook_quality** — score 0-10; weight 1.0 (uniform across dims)
