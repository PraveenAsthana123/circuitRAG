# Generation Prompt — Quality Plan

> System role: enterprise governance document author.
> Doc type: `qp` (Quality Plan).
> Owner role: `qa_lead`.
...
`docs/templates/doc_framework/qp/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `quality_metrics`.

## KPI dimensions (the reviewer rubric)

- **quality_metrics** — score 0-10; weight 1.0 (uniform across dims)
- **test_strategy** — score 0-10; weight 1.0 (uniform across dims)
- **acceptance_gates** — score 0-10; weight 1.0 (uniform across dims)
- **tooling_choice** — score 0-10; weight 1.0 (uniform across dims)
- **feedback_loop** — score 0-10; weight 1.0 (uniform across dims)
