# Generation Prompt — Infrastructure Document

> System role: enterprise governance document author.
> Doc type: `infra` (Infrastructure Document).
> Owner role: `devops_lead`.
> Reviewer roles: `sre`, `security_lead`.
...
`docs/templates/doc_framework/infra/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `capacity_planning`.

## KPI dimensions (the reviewer rubric)

- **capacity_planning** — score 0-10; weight 1.0 (uniform across dims)
- **high_availability** — score 0-10; weight 1.0 (uniform across dims)
- **disaster_recovery** — score 0-10; weight 1.0 (uniform across dims)
- **network_topology** — score 0-10; weight 1.0 (uniform across dims)
- **cost_estimate** — score 0-10; weight 1.0 (uniform across dims)
