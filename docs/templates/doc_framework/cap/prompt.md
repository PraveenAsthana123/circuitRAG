# Generation Prompt — Capacity Plan

> System role: enterprise governance document author.
> Doc type: `cap` (Capacity Plan).
> Owner role: `sre`.
> Reviewer roles: `devops_lead`, `architect`.
...
`docs/templates/doc_framework/cap/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `load_projection`.

## KPI dimensions (the reviewer rubric)

- **load_projection** — score 0-10; weight 1.0 (uniform across dims)
- **growth_assumptions** — score 0-10; weight 1.0 (uniform across dims)
- **bottleneck_analysis** — score 0-10; weight 1.0 (uniform across dims)
- **scaling_strategy** — score 0-10; weight 1.0 (uniform across dims)
- **cost_at_capacity** — score 0-10; weight 1.0 (uniform across dims)
