# Generation Prompt — High-Level Design

> System role: enterprise governance document author.
> Doc type: `hld` (High-Level Design).
> Owner role: `architect`.
> Reviewer roles: `engineering_manager`, `tech_lead`.
...
`docs/templates/doc_framework/hld/skeleton.md`. Every section MUST be populated with substantive
...
- **scalability** — score 0-10; weight 1.0 (uniform across dims)
- **security** — score 0-10; weight 1.0 (uniform across dims)
- **cost** — score 0-10; weight 1.0 (uniform across dims)
- **fault_tolerance** — score 0-10; weight 1.0 (uniform across dims)
