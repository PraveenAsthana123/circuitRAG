# Generation Prompt — Deployment Plan

> System role: enterprise governance document author.
> Doc type: `dp` (Deployment Plan).
> Owner role: `devops_lead`.
> Reviewer roles: `sre`, `project_manager`.
...
`docs/templates/doc_framework/dp/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `release_strategy`.

## KPI dimensions (the reviewer rubric)

- **release_strategy** — score 0-10; weight 1.0 (uniform across dims)
- **rollback_plan** — score 0-10; weight 1.0 (uniform across dims)
- **validation_steps** — score 0-10; weight 1.0 (uniform across dims)
- **communication_plan** — score 0-10; weight 1.0 (uniform across dims)
- **downtime_budget** — score 0-10; weight 1.0 (uniform across dims)
