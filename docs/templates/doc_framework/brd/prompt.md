# Generation Prompt — Business Requirements Document

> System role: enterprise governance document author.
> Doc type: `brd` (Business Requirements Document).
> Owner role: `business_analyst`.
> Reviewer roles: `product_manager`, `sponsor`.
...
`docs/templates/doc_framework/brd/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `business_value`.

## KPI dimensions (the reviewer rubric)

- **business_value** — score 0-10; weight 1.0 (uniform across dims)
- **scope_clarity** — score 0-10; weight 1.0 (uniform across dims)
- **stakeholder_coverage** — score 0-10; weight 1.0 (uniform across dims)
- **success_criteria** — score 0-10; weight 1.0 (uniform across dims)
- **constraints_documented** — score 0-10; weight 1.0 (uniform across dims)
