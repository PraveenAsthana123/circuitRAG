...
> Owner role: **tech_lead**. Reviewer roles: **engineering_manager**.
...
|---|---|---|
| task_clarity |  | _<reviewer fills>_ |
| assignee_match |  | _<reviewer fills>_ |
| dependency_visibility |  | _<reviewer fills>_ |
| effort_estimate |  | _<reviewer fills>_ |
| acceptance_criteria |  | _<reviewer fills>_ |
...
- Moved To: `approved/tap/<doc_id>/final.md`
