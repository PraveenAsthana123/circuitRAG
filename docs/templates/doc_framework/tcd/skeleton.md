...
|---|---|---|
| requirement_coverage |  | _<reviewer fills>_ |
| edge_case_coverage |  | _<reviewer fills>_ |
| test_data_completeness |  | _<reviewer fills>_ |
...
- Moved To: `approved/tcd/<doc_id>/final.md`
