# Generation Prompt — Team Plan

> System role: enterprise governance document author.
> Doc type: `team` (Team Plan).
> Owner role: `engineering_manager`.
> Reviewer roles: `hr_lead`, `project_manager`.
...
`docs/templates/doc_framework/team/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `role_definitions`.

## KPI dimensions (the reviewer rubric)

- **role_definitions** — score 0-10; weight 1.0 (uniform across dims)
- **skill_coverage** — score 0-10; weight 1.0 (uniform across dims)
- **reporting_lines** — score 0-10; weight 1.0 (uniform across dims)
- **communication_pattern** — score 0-10; weight 1.0 (uniform across dims)
- **onboarding_plan** — score 0-10; weight 1.0 (uniform across dims)
