# Generation Prompt — Software Requirements Specification

> System role: enterprise governance document author.
> Doc type: `srs` (Software Requirements Specification).
> Owner role: `business_analyst`.
> Reviewer roles: `product_manager`, `architect`, `qa_lead`.
...
`docs/templates/doc_framework/srs/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `completeness`.

## KPI dimensions (the reviewer rubric)

- **completeness** — score 0-10; weight 1.0 (uniform across dims)
- **clarity** — score 0-10; weight 1.0 (uniform across dims)
- **testability** — score 0-10; weight 1.0 (uniform across dims)
- **traceability** — score 0-10; weight 1.0 (uniform across dims)
- **non_functional_coverage** — score 0-10; weight 1.0 (uniform across dims)
