# Generation Prompt — Risk Plan

> System role: enterprise governance document author.
> Doc type: `risk` (Risk Plan).
> Owner role: `project_manager`.
> Reviewer roles: `security_lead`, `compliance_officer`.
...
`docs/templates/doc_framework/risk/skeleton.md`. Every section MUST be populated with substantive
content derived from the business use-case + prior feedback. A section
saying "TBD" or "to be determined" fails KPI dimension `identification`.

## KPI dimensions (the reviewer rubric)

- **identification** — score 0-10; weight 1.0 (uniform across dims)
- **probability** — score 0-10; weight 1.0 (uniform across dims)
- **impact** — score 0-10; weight 1.0 (uniform across dims)
- **mitigation** — score 0-10; weight 1.0 (uniform across dims)
- **monitoring** — score 0-10; weight 1.0 (uniform across dims)
