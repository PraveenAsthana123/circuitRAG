# `mcp/server_datadog.py` — Brutal Tool Review
...
**Source:** `mcp/server_datadog.py`
**Catalog:** `config/tool_catalog/datadog.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/datadog.yaml`; ADR via SDLC ADR set |
