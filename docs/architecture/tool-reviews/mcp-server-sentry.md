# `mcp/server_sentry.py` — Brutal Tool Review
...
**Source:** `mcp/server_sentry.py`
**Catalog:** `config/tool_catalog/sentry.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/sentry.yaml`; ADR via SDLC ADR set |
