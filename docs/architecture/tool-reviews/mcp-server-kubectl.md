# `mcp/server_kubectl.py` — Brutal Tool Review
...
**Source:** `mcp/server_kubectl.py`
**Catalog:** `config/tool_catalog/kubectl.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/kubectl.yaml`; ADR via SDLC ADR set |
