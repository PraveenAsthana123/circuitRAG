# `mcp/server_itsm.py` — Brutal Tool Review
...
**Source:** `mcp/server_itsm.py`
**Catalog:** `config/tool_catalog/itsm.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/itsm.yaml`; ADR via SDLC ADR set |
