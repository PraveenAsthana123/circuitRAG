# `mcp/server_gdrive.py` — Brutal Tool Review
...
**Source:** `mcp/server_gdrive.py`
**Catalog:** `config/tool_catalog/gdrive.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/gdrive.yaml`; ADR via SDLC ADR set |
