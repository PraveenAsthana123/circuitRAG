# `mcp/server_whatsapp.py` — Brutal Tool Review
...
**Source:** `mcp/server_whatsapp.py`
**Catalog:** `config/tool_catalog/whatsapp.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/whatsapp.yaml`; ADR via SDLC ADR set |
