# `mcp/server_jira.py` — Brutal Tool Review
...
**Source:** `mcp/server_jira.py`
**Catalog:** `config/tool_catalog/jira.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/jira.yaml`; ADR via SDLC ADR set |
