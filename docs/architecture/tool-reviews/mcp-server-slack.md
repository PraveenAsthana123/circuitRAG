# `mcp/server_slack.py` — Brutal Tool Review
...
**Source:** `mcp/server_slack.py`
**Catalog:** `config/tool_catalog/slack.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/slack.yaml`; ADR via SDLC ADR set |
