# `mcp/server_sonarqube.py` — Brutal Tool Review
...
**Source:** `mcp/server_sonarqube.py`
**Catalog:** `config/tool_catalog/sonarqube.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/sonarqube.yaml`; ADR via SDLC ADR set |
