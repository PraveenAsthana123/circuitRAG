# `mcp/server_hr.py` — Brutal Tool Review
...
**Source:** `mcp/server_hr.py`
**Catalog:** `config/tool_catalog/hr.yaml`
...
| P1 (silent-degradation) | 19 | 1, 2, 6, 7, 8, 10, 11, 12, 14, 19, 23, 24, 25, 29, 32, 33, 34, 36, 39 |
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/hr.yaml`; ADR via SDLC ADR set |
