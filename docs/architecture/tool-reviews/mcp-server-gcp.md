# `mcp/server_gcp.py` — Brutal Tool Review
...
**Source:** `mcp/server_gcp.py`
**Catalog:** `config/tool_catalog/gcp.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/gcp.yaml`; ADR via SDLC ADR set |
