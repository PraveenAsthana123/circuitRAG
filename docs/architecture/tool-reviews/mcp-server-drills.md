# `mcp/server_drills.py` — Brutal Tool Review
...
**Source:** `mcp/server_drills.py`
**Catalog:** `config/tool_catalog/drills.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/drills.yaml`; ADR via SDLC ADR set |
