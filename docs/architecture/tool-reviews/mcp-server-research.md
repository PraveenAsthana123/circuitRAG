...
| 5 | Narrowed exception scope | ✗ | BACKLOG: narrow bare `except Exception:` to specific types |
...
> 2 P0 row(s) blocking; close before claiming production-grade for this namespace.
