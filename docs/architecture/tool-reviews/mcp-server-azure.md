# `mcp/server_azure.py` — Brutal Tool Review
...
**Source:** `mcp/server_azure.py`
**Catalog:** `config/tool_catalog/azure.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/azure.yaml`; ADR via SDLC ADR set |
