# `mcp/server_servicenow.py` — Brutal Tool Review
...
**Source:** `mcp/server_servicenow.py`
**Catalog:** `config/tool_catalog/servicenow.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/servicenow.yaml`; ADR via SDLC ADR set |
