# `mcp/server_confluence.py` — Brutal Tool Review
...
**Source:** `mcp/server_confluence.py`
**Catalog:** `config/tool_catalog/confluence.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/confluence.yaml`; ADR via SDLC ADR set |
