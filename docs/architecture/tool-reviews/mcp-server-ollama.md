# `mcp/server_ollama.py` — Brutal Tool Review
...
**Source:** `mcp/server_ollama.py`
**Catalog:** `config/tool_catalog/ollama.yaml`
...
| P1 (silent-degradation) | 21 | 2, 6, 7, 8, 9, 10, 11, 12, 14, 19, 23, 24, 25, 26, 29, 32, 33, 34, 36, 37, 39 |
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/ollama.yaml`; ADR via SDLC ADR set |
