# `mcp/server_github.py` — Brutal Tool Review
...
**Source:** `mcp/server_github.py`
**Catalog:** `config/tool_catalog/github.yaml`
...
| P1 (silent-degradation) | 19 | 2, 7, 8, 9, 10, 11, 12, 14, 19, 23, 24, 25, 26, 29, 32, 33, 34, 36, 39 |
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/github.yaml`; ADR via SDLC ADR set |
