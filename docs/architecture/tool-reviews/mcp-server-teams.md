# `mcp/server_teams.py` — Brutal Tool Review
...
**Source:** `mcp/server_teams.py`
**Catalog:** `config/tool_catalog/teams.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/teams.yaml`; ADR via SDLC ADR set |
