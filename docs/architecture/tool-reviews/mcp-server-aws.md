# `mcp/server_aws.py` — Brutal Tool Review
...
**Source:** `mcp/server_aws.py`
**Catalog:** `config/tool_catalog/aws.yaml`
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/aws.yaml`; ADR via SDLC ADR set |
