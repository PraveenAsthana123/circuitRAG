# `mcp/server_csv_ingest.py` — Brutal Tool Review
...
**Source:** `mcp/server_csv_ingest.py`
**Catalog:** `config/tool_catalog/csv_ingest.yaml`
...
| P1 (silent-degradation) | 20 | 1, 2, 6, 7, 8, 9, 10, 11, 12, 14, 19, 23, 24, 25, 29, 32, 33, 34, 36, 39 |
...
| Architect | ✓ | C4 position locked via `config/tool_catalog/csv_ingest.yaml`; ADR via SDLC ADR set |
