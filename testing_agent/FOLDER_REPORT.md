...
**Folder under review:** `testing_agent`
...
| Field | Value |
|---|---|
| Folder Name | testing_agent |
| Relative Path | testing_agent |
| Absolute Path | /mnt/deepa/rag/testing_agent |
| Runtime Detected | Python (3 files) |
| File Count | 4 |
| Lines of Code (rough) | 242 |
| README present | Yes |
