...
**Folder under review:** `services/api-gateway`
...
| Relative Path | services/api-gateway |
| Absolute Path | /mnt/deepa/rag/services/api-gateway |
| Runtime Detected | Go (8 files) |
| File Count | 12 |
| Lines of Code (rough) | 738 |
| README present | Yes |
| Dockerfile present | Yes |
| Tests dir present | No |
| Top Git Contributors | 5	PraveenAsthana123, 3	Praveen |
| External DB Dependencies (detected) | Redis |
