...
🧩 **Service**  ·  **Path:** `services/sidecar-advisor`  ·  **Generated:** 2026-05-16 23:27 UTC
...
| go.mod | ❌ |
| package.json | ❌ |
| Top git contributors | `30	PraveenAsthana123` |
...
| 7 | Timeouts on all external calls | **10** | ✓ timeout= or asyncio.wait_for — detected at `git_capture.py:105` |
