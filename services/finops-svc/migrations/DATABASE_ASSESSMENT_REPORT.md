...
| Field | Value |
|---|---|
| Folder | `services/finops-svc/migrations` |
| Profile | Database |
...
| Database engines (detected) | _(none)_ |
| Row-Level Security present | yes |
| JSONB column type used | no |
| Partition tables | no |
| `CREATE INDEX CONCURRENTLY` used | no |
| Foreign keys defined | no |
...
|---|---|---|---|---|
| 1. Database engine documented? Detected: NONE | TBD | — | — | — |
| 2. Normalized to 3NF (no redundant columns)? | TBD | — | — | — |
| 3. Foreign keys defined? Detected: False | TBD | — | — | — |
...
| # / Item | Status | Notes | Risk (H/M/L) | Recommendation |
|---|---|---|---|---|
| 1. Migration files numbered + ordered? Detected: 2 files | TBD | — | — | — |
...
| # / Item | Status | Notes | Risk (H/M/L) | Recommendation |
|---|---|---|---|---|
| 1. Row-Level Security policies enabled? Detected: True | TBD | — | — | — |
...
| # / Item | Status | Notes | Risk (H/M/L) | Recommendation |
|---|---|---|---|---|
| 1. JSONB for flexible schema? Detected: False | TBD | — | — | — |
