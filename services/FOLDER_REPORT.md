...
| Absolute Path | /mnt/deepa/rag/services |
| Runtime Detected | Python (243 files) · TypeScript/JS (1019 files) · Go (17 files) |
| File Count | 2398 |
| Lines of Code (rough) | 180,388 |
| README present | Yes |
| Dockerfile present | Yes |
| Tests dir present | Yes |
| Top Git Contributors | 354	PraveenAsthana123, 8	Praveen |
...
| AI / LLM Dependencies (detected) | Anthropic SDK, Giskard, LangChain, LangGraph, Ollama client, OpenAI SDK, Ragas, Rebuff (prompt injection) |
