...
🧩 **Service**  ·  **Path:** `services/retrieval-svc`  ·  **Generated:** 2026-05-16 23:27 UTC
...
| go.mod | ❌ |
| package.json | ❌ |
| Top git contributors | `37	PraveenAsthana123`, `4	Praveen` |
...
| 2 | Circuit breaker on external deps | **10** | ✓ CircuitBreaker wired — detected at `app/services/embedder_client.py:14` |
| 3 | Graceful degradation path | TBD | reviewer audit |
| 4 | Health probe (startup/liveness/readiness) | **10** | ✓ `/health` endpoint — detected at `app/routers/__init__.py:26` |
...
| 3 | Structured JSON logs | **10** | ✓ structured logger — detected at `app/main.py:48` |
| 4 | correlation_id propagated everywhere | **10** | ✓ correlation_id used — detected at `app/main.py:131` |
