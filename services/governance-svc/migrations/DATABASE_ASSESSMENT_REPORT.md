...
| Field | Value |
|---|---|
| Folder | `services/governance-svc/migrations` |
| Profile | Database |
...
| Git authors | 11	PraveenAsthana123, 1	Praveen |
| Reviewer | Praveen Asthana |
| Generated | 2026-05-17 02:05 UTC |
...
| # / Item | Status | Notes | Risk (H/M/L) | Recommendation |
|---|---|---|---|---|
| 1. Migration files numbered + ordered? Detected: 11 files | TBD | — | — | — |
...
| # / Item | Status | Notes | Risk (H/M/L) | Recommendation |
|---|---|---|---|---|
| 1. Partitioned tables? Detected: True | TBD | — | — | — |
