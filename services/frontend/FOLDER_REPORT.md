...
**Folder under review:** `services/frontend`
**Generated:** 2026-05-16 22:04 UTC
...
| Relative Path | services/frontend |
| Absolute Path | /mnt/deepa/rag/services/frontend |
| Runtime Detected | TypeScript/JS (1018 files) |
| File Count | 1938 |
| Lines of Code (rough) | 152,723 |
| README present | Yes |
| Dockerfile present | Yes |
| Tests dir present | Yes |
| Top Git Contributors | 191	PraveenAsthana123, 4	Praveen |
| External DB Dependencies (detected) | Elasticsearch, Neo4j, Postgres (asyncpg), Postgres (psycopg), Qdrant, Redis, SQLAlchemy |
...
| AI / LLM Dependencies (detected) | Anthropic SDK, LangChain, LangGraph, Ragas |
| Reviewer | Praveen Asthana |
| Review Date | 2026-05-16 22:04 UTC |
