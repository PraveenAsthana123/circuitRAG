...
**Folder under review:** `ops_worker`
...
| Field | Value |
|---|---|
| Folder Name | ops_worker |
| Relative Path | ops_worker |
| Absolute Path | /mnt/deepa/rag/ops_worker |
| Runtime Detected | Python (6 files) |
| File Count | 9 |
| Lines of Code (rough) | 962 |
| README present | Yes |
| Dockerfile present | No |
| Tests dir present | No |
| Top Git Contributors | 5	PraveenAsthana123 |
| External DB Dependencies (detected) | Postgres (asyncpg) |
| External HTTP Dependencies (detected) | requests |
| Queue / Event Dependencies (detected) | (none detected) |
| AI / LLM Dependencies (detected) | Anthropic SDK |
