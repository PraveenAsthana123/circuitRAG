...
| Folder Name | libs |
| Relative Path | libs |
| Absolute Path | /mnt/deepa/rag/libs |
| Runtime Detected | Python (65 files) |
| File Count | 91 |
| Lines of Code (rough) | 12,249 |
| README present | Yes |
| Dockerfile present | No |
| Tests dir present | Yes |
| Top Git Contributors | 58	PraveenAsthana123, 7	Praveen |
