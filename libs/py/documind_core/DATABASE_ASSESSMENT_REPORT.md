# Database Assessment - `documind_core`

**Profile:** Database (Unknown)
**Generated:** 2026-05-17 02:04 UTC
...
| Alembic detected | no |
| Flyway detected | no |
| ORM / DB client libs | asyncpg (raw) |
...
| Git authors | 53	PraveenAsthana123, 6	Praveen |
| Reviewer | Praveen Asthana |
| Generated | 2026-05-17 02:04 UTC |
...
| # / Item | Status | Notes | Risk (H/M/L) | Recommendation |
|---|---|---|---|---|
| 1. Migration files numbered + ordered? Detected: 0 files | TBD | — | — | — |
