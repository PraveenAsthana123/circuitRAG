...
📚 **Library**  ·  **Path:** `libs/py/tests`  ·  **Generated:** 2026-05-16 23:25 UTC
...
| go.mod | ❌ |
| package.json | ❌ |
| Top git contributors | `21	PraveenAsthana123`, `4	Praveen` |
...
| 6 | Async I/O where applicable | **10** | 100 async functions detected |
...
| 2 | Circuit breaker on external deps | **10** | ✓ CircuitBreaker wired — detected at `test_breakers.py:7` |
...
| 3 | Structured JSON logs | **10** | ✓ structured logger — detected at `test_logging_config.py:5` |
| 4 | correlation_id propagated everywhere | **10** | ✓ correlation_id used — detected at `test_error_tracking.py:121` |
...
| 10 | Decision audit row per AI call (§38+§48) | **10** | ✓ decision_audit ref — detected at `test_audit.py:11` |
