# 📦 `personalization` — Advanced README
  ...
  ·  **Path:** `personalization`  ·  **Generated:** 2026-05-16 23:25 UTC
...
| 7 | Timeouts on all external calls | **10** | ✓ timeout= or asyncio.wait_for — detected at `modelfile_builder.py:120` |
