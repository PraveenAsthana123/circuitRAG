...
**Folder under review:** `personalization`
...
| Relative Path | personalization |
| Absolute Path | /mnt/deepa/rag/personalization |
| Runtime Detected | Python (7 files) |
| File Count | 11 |
| Lines of Code (rough) | 944 |
| README present | Yes |
...
| AI / LLM Dependencies (detected) | LangGraph |
