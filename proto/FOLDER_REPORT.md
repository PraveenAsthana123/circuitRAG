...
| Folder Name | proto |
| Relative Path | proto |
| Absolute Path | /mnt/deepa/rag/proto |
| Runtime Detected | Python (33 files) |
| File Count | 40 |
| Lines of Code (rough) | 1,478 |
| README present | Yes |
| Dockerfile present | No |
| Tests dir present | No |
| Top Git Contributors | 5	PraveenAsthana123, 2	Praveen |
