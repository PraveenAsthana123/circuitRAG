# 📦 `proto` — Advanced README
  ...
  ·  **Path:** `proto`  ·  **Generated:** 2026-05-16 23:25 UTC
...
| go.mod | ❌ |
| package.json | ❌ |
| Top git contributors | `7	PraveenAsthana123`, `2	Praveen` |

#### Longest functions (top 5)

| Location | Name | Lines |
|---|---|---|
| `identity/v1/identity_pb2_grpc.py:149` | `add_IdentityServiceServicer_to_server` | 52 |
| `identity/v1/identity_pb2_grpc.py:35` | `__init__` | 51 |
| `openclaw/v1/openclaw_pb2_grpc.py:111` | `add_OpenClawServiceServicer_to_server` | 27 |
| `openclaw/v1/openclaw_pb2_grpc.py:43` | `__init__` | 26 |
| `retrieval/v1/retrieval_pb2_grpc.py:99` | `Health` | 25 |
...
1. **`common/v1/common_pb2.py`** (🛠 utility / helper, 56 LOC) — Generated protocol buffer code.
2. **`common/v1/common_pb2_grpc.py`** (🛠 utility / helper, 25 LOC) — Client and server classes corresponding to protobuf-defined services.
3. **`identity/v1/identity_pb2_grpc.py`** (📄 module, 452 LOC) — Client and server classes corresponding to protobuf-defined services.
4. **`openclaw/v1/openclaw_pb2_grpc.py`** (📄 module, 262 LOC) — Client and server classes corresponding to protobuf-defined services.
5. **`paperclip/v1/paperclip_pb2_grpc.py`** (📄 module, 222 LOC) — Client and server classes corresponding to protobuf-defined services.
6. **`inference/v1/inference_pb2_grpc.py`** (📄 module, 200 LOC) — Client and server classes corresponding to protobuf-defined services.
7. **`retrieval/v1/retrieval_pb2_grpc.py`** (📄 module, 151 LOC) — Client and server classes corresponding to protobuf-defined services.
8. **`paperclip/v1/paperclip_pb2.py`** (📄 module, 73 LOC) — Generated protocol buffer code.
...
|---|---|---|---|---|---|
| `common/v1/common_pb2.py` | 🛠 utility / helper | 0 | 0 | 56 | Generated protocol buffer code. |
| `common/v1/common_pb2_grpc.py` | 🛠 utility / helper | 0 | 0 | 25 | Client and server classes corresponding to protobuf-defined services. |
| `identity/v1/identity_pb2.py` | 📄 module | 0 | 0 | 65 | Generated protocol buffer code. |
| `identity/v1/identity_pb2_grpc.py` | 📄 module | 3 | 1 | 452 | Client and server classes corresponding to protobuf-defined services. |
| `inference/v1/inference_pb2.py` | 📄 module | 0 | 0 | 51 | Generated protocol buffer code. |
| `inference/v1/inference_pb2_grpc.py` | 📄 module | 3 | 1 | 200 | Client and server classes corresponding to protobuf-defined services. |
| `openclaw/v1/openclaw_pb2.py` | 📄 module | 0 | 0 | 59 | Generated protocol buffer code. |
| `openclaw/v1/openclaw_pb2_grpc.py` | 📄 module | 3 | 1 | 262 | Client and server classes corresponding to protobuf-defined services. |
| `paperclip/v1/paperclip_pb2.py` | 📄 module | 0 | 0 | 73 | Generated protocol buffer code. |
| `paperclip/v1/paperclip_pb2_grpc.py` | 📄 module | 3 | 1 | 222 | Client and server classes corresponding to protobuf-defined services. |
| `retrieval/v1/retrieval_pb2.py` | 📄 module | 0 | 0 | 53 | Generated protocol buffer code. |
| `retrieval/v1/retrieval_pb2_grpc.py` | 📄 module | 3 | 1 | 151 | Client and server classes corresponding to protobuf-defined services. |

### Absolute paths (clickable)

- `/mnt/deepa/rag/proto/common/v1/common_pb2.py`
- `/mnt/deepa/rag/proto/common/v1/common_pb2_grpc.py`
- `/mnt/deepa/rag/proto/identity/v1/identity_pb2.py`
- `/mnt/deepa/rag/proto/identity/v1/identity_pb2_grpc.py`
- `/mnt/deepa/rag/proto/inference/v1/inference_pb2.py`
- `/mnt/deepa/rag/proto/inference/v1/inference_pb2_grpc.py`
- `/mnt/deepa/rag/proto/openclaw/v1/openclaw_pb2.py`
- `/mnt/deepa/rag/proto/openclaw/v1/openclaw_pb2_grpc.py`
- `/mnt/deepa/rag/proto/paperclip/v1/paperclip_pb2.py`
- `/mnt/deepa/rag/proto/paperclip/v1/paperclip_pb2_grpc.py`
- `/mnt/deepa/rag/proto/retrieval/v1/retrieval_pb2.py`
- `/mnt/deepa/rag/proto/retrieval/v1/retrieval_pb2_grpc.py`
...
```mermaid
flowchart LR
    Caller([External Caller]) --> This["proto"]
```
...
flowchart TB
    subgraph __utility___helper["🛠 utility / helper"]
        common_v1_common_pb2_py["common/v1/common_pb2.py"]
        common_v1_common_pb2_grpc_py["common/v1/common_pb2_grpc.py"]
    end
    subgraph __module["📄 module"]
        identity_v1_identity_pb2_py["identity/v1/identity_pb2.py"]
        identity_v1_identity_pb2_grpc_py["identity/v1/identity_pb2_grpc.py"]
        inference_v1_inference_pb2_py["inference/v1/inference_pb2.py"]
        inference_v1_inference_pb2_grpc_py["inference/v1/inference_pb2_grpc.py"]
        openclaw_v1_openclaw_pb2_py["openclaw/v1/openclaw_pb2.py"]
        openclaw_v1_openclaw_pb2_grpc_py["openclaw/v1/openclaw_pb2_grpc.py"]
...
```mermaid
flowchart TB
    identity_v1_identity_pb2_grpc_py_149_add["add_IdentityServiceServicer_to_server (52 lines)<br/>identity/v1/identity_pb2_grpc.py:149"]
    identity_v1_identity_pb2_grpc_py_35___in["__init__ (51 lines)<br/>identity/v1/identity_pb2_grpc.py:35"]
    openclaw_v1_openclaw_pb2_grpc_py_111_add["add_OpenClawServiceServicer_to_server (27 lines)<br/>openclaw/v1/openclaw_pb2_grpc.py:111"]
    openclaw_v1_openclaw_pb2_grpc_py_43___in["__init__ (26 lines)<br/>openclaw/v1/openclaw_pb2_grpc.py:43"]
    retrieval_v1_retrieval_pb2_grpc_py_99_He["Health (25 lines)<br/>retrieval/v1/retrieval_pb2_grpc.py:99"]
```
...
classDiagram
    class IdentityServiceServicer {
        +9 methods
        ~identity/v1/identity_pb2_grpc.py:88
    }
    object <|.. IdentityServiceServicer
    class IdentityService {
        +9 methods
        ~identity/v1/identity_pb2_grpc.py:204
    }
    object <|.. IdentityService
    class OpenClawServiceServicer {
        +4 methods
        ~openclaw/v1/openclaw_pb2_grpc.py:71
    }
    object <|.. OpenClawServiceServicer
    class OpenClawService {
        +4 methods
        ~openclaw/v1/openclaw_pb2_grpc.py:141
    }
    object <|.. OpenClawService
    class InferenceServiceServicer {
        +3 methods
        ~inference/v1/inference_pb2_grpc.py:59
    }
    object <|.. InferenceServiceServicer
    class InferenceService {
        +3 methods
        ~inference/v1/inference_pb2_grpc.py:113
    }
    object <|.. InferenceService
    class PaperclipServiceServicer {
        +3 methods
        ~paperclip/v1/paperclip_pb2_grpc.py:67
    }
    object <|.. PaperclipServiceServicer
    class PaperclipService {
        +3 methods
        ~paperclip/v1/paperclip_pb2_grpc.py:127
    }
    object <|.. PaperclipService
    class RetrievalServiceServicer {
        +2 methods
        ~retrieval/v1/retrieval_pb2_grpc.py:53
    }
    object <|.. RetrievalServiceServicer
    class RetrievalService {
        +2 methods
        ~retrieval/v1/retrieval_pb2_grpc.py:92
    }
    object <|.. RetrievalService
    class InferenceServiceStub {
        +1 methods
        ~inference/v1/inference_pb2_grpc.py:29
    }
    object <|.. InferenceServiceStub
    class RetrievalServiceStub {
        +1 methods
        ~retrieval/v1/retrieval_pb2_grpc.py:29
    }
    object <|.. RetrievalServiceStub
    class IdentityServiceStub {
        +1 methods
        ~identity/v1/identity_pb2_grpc.py:29
    }
    object <|.. IdentityServiceStub
    class PaperclipServiceStub {
        +1 methods
        ~paperclip/v1/paperclip_pb2_grpc.py:29
    }
    object <|.. PaperclipServiceStub
    class OpenClawServiceStub {
        +1 methods
        ~openclaw/v1/openclaw_pb2_grpc.py:29
    }
    object <|.. OpenClawServiceStub
```
...
|---|---|
| **Single business capability** | `proto` owns ONE capability (see §1 Purpose). Cross-capability logic lives in other services. |
...
```
1. Tail logs:        tail -50 /tmp/proto.log   (if host-side)
                     docker logs documind-proto --tail=50   (if container)
2. Health probe:     curl http://localhost:<PORT>/health
3. Fleet probe:      python3 scripts/advanced_healthcheck.py --layer app
4. Trace:            Open Jaeger → search request_id → see span tree
5. Metrics:          Open Grafana → service dashboard → look for spike
6. Drill:            ls mcp/tests/drill_*proto*.py and run
```
...
| `42da32a` | 2026-05-03 | feat(grpc): paperclip + openclaw protos extend the gRPC layer |
| `7352dac` | 2026-04-23 | fix(remediation-2): close concrete bugs from brutal-feedback pass |

```bash
git log --oneline -- proto    # see all commits
