...
| Absolute Path | /mnt/deepa/rag/scripts |
| Runtime Detected | Python (119 files) · TypeScript/JS (1 files) |
| File Count | 162 |
| Lines of Code (rough) | 43,469 |
| README present | Yes |
| Dockerfile present | No |
| Tests dir present | No |
| Top Git Contributors | 221	PraveenAsthana123, 2	Praveen |
...
| AI / LLM Dependencies (detected) | Anthropic SDK, Giskard, LangChain, LangGraph, Ragas, Rebuff (prompt injection) |
