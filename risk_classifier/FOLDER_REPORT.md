...
**Folder under review:** `risk_classifier`
...
| Field | Value |
|---|---|
| Folder Name | risk_classifier |
| Relative Path | risk_classifier |
| Absolute Path | /mnt/deepa/rag/risk_classifier |
| Runtime Detected | Python (2 files) |
| File Count | 3 |
| Lines of Code (rough) | 186 |
| README present | Yes |
