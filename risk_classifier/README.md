# 📦 `risk_classifier` — Advanced README
  ...
  ·  **Path:** `risk_classifier`  ·  **Generated:** 2026-05-16 19:57 UTC
...
|---|---|---|---|---|---|
| `__init__.py` | 🚀 entry point / app bootstrap | 0 | 0 | 31 | risk_classifier — pure-function classification over (action, type, text). |
